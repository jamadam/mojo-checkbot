$(function() {
    ...
    function fetch() {
        ...
        $.get('/diff?offset=' + offset + '&offset_d=' + offset_d, function(msg){
            ...
            $.each(msg.result, function(idx, data){
                ...
                fixed_data.html(msg.fixed + '/' + msg.queues);
    ...
    function constructNotifier(data) {
        ...
        dom.append($('<div/>').html(data[dataKey.context]));
        dom.append($('<div/>').html(data[dataKey.referer]));
    ...
    function showLightbox(lb, data) {
        var p_table = $('#propetyTemplate').clone().show();
