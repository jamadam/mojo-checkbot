...
# Default application
is(MojoCheckbot::UserAgent->app,      app, 'applications are equal');
is(MojoCheckbot::UserAgent->new->app, app, 'applications are equal');
MojoCheckbot::UserAgent->app(app);
is(MojoCheckbot::UserAgent->app, app, 'applications are equal');
my $dummy = Mojolicious::Lite->new;
isnt(MojoCheckbot::UserAgent->new->app($dummy)->app, app,
  'applications are not equal');
is(MojoCheckbot::UserAgent->app, app, 'applications are still equal');
MojoCheckbot::UserAgent->app($dummy);
isnt(MojoCheckbot::UserAgent->app, app, 'applications are not equal');
is(MojoCheckbot::UserAgent->app, $dummy, 'application are equal');
MojoCheckbot::UserAgent->app(app);
is(MojoCheckbot::UserAgent->app, app, 'applications are equal again');
